...
const client = new discord.Client() // Not Importan
...
const Settings = {
  //THIS IS IMPORTANT\\
  GUILD_ID: "1032714011151708261", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR SERVER, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  OWNER_ID: "1032712866131886111", // THIS IS VERY IMPORTANT, THIS IS THE ID OF YOUR PROFILE, SEARCH ON YOUTUBE HOW TO GET IT IF YOU DONT KNOW HOW
  Shoppy_API_KEY: "b5EsitoYSNS0Q15dsgJAZfJ5xJmT6vLWZPtJpB5vZwL2Lf2izo", // Create a Shoppy account If you haven't, then go to https://shoppy.gg/user/settings and look for your "API-KEY".
  Whitelisted_Role_ID: "1038239546283921498", // When users use the !whitelist or !rewhitelist command, they get this role.
  Blacklisted_Role_ID: "1038239583067963512", // When users who are not whitelist use the !rewhitelist command with a buyers Shoppy Order ID, they get this role.
  LogsChannel_Channel_ID: "1038239698939809912", // Create a channel for logs when a user is whtelisted or uses a command!
  //----------------\\
